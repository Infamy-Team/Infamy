...
{	
  ...
  var varpreview : SerializedProperty;
  ...
  //var dynamicLayers : SerializedProperty;
    ...
    varpreview = serObj.FindProperty ("preview");
  ...
  function OnInspectorGUI () {         
    ...
    EditorGUILayout.PropertyField (varpreview, new GUIContent("Preview"));
    if (varpreview.boolValue)
