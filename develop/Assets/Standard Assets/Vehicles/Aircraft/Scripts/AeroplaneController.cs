...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
    ...
    public class AeroplaneController : MonoBehaviour
    {
        ...
        #region Por defecto
        [SerializeField] private float m_MaxEnginePower = 80f;        // The maximum output of the engine.
        ...
        // Spawn bombas
        [SerializeField] private GameObject m_PosicionSpawn;
        [SerializeField] private GameObject m_PrefabBomba;
        [SerializeField] private float m_tiempoDisparo = 2;
        [SerializeField] public int m_cantidadBombas = 6;
        ...
        void Update()
        {
            if (Input.GetKeyUp("space") && this.CompareTag("Player") && estadoBomba == EstadoBomba.PREPARADO)
            {
                Disparar();
            }
        }
        ...
        public void SpawnBombas()
        {
            ...
            rigid.AddForce(acceleracionAvion * rigid.mass / 2);
            m_cantidadBombas--;
